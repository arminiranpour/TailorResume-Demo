...
class DummyProvider(LLMProvider):
    def generate(self, messages, *, timeout=None, **kwargs):
        return json.dumps(
            {
                "bullet_id": "exp_1_b1",
                "rewritten_text": "Led migrations to Kubernetes for backend services.",
...
def sample_plan():
    return {
        "bullet_actions": [
            {"bullet_id": "exp_1_b1", "rewrite_intent": "rewrite", "target_keywords": ["Kubernetes"]}
        ],
        "missing_requirements": [],
